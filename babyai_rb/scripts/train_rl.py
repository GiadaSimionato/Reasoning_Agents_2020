...
if args.algo == "ppo":
    algo = babyai.rl.PPOAlgo(envs, rbs, acmodel, args.frames_per_proc, args.discount, args.lr, args.beta1, args.beta2,
                             args.gae_lambda,
                             args.entropy_coef, args.value_loss_coef, args.max_grad_norm, args.recurrence,
                             args.optim_eps, args.clip_eps, args.ppo_epochs, args.batch_size, obss_preprocessor,
                             reshape_reward, rb_prop=args.rb_prop)
else:
...
header = (["update", "episodes", "frames", "FPS", "duration"]
          ...
          + ["return_bolt_" + stat for stat in ['mean', 'std', 'min', 'max']]
          + ["return_vanilla_" + stat for stat in ['mean', 'std', 'min', 'max']]
          + ["success_rate"]
